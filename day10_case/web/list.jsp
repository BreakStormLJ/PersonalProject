...
<div class="container">
    ...
    <div style="float: left;">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            <div class="form-group">
                ...
                <%--回写--%>
                <%--刷新重载界面数据时，回写查询条件数据 value="${condition.name[0]}"--%>
                <input type="text" name="name" value="${condition.name[0]}" class="form-control" id="exampleInputName2" >
            </div>
            <div class="form-group">
                <label for="exampleInputName3">籍贯</label>
                <%--回写--%>
                <%--刷新重载界面数据时，回写查询条件数据 value="${condition.address[0]}"--%>
            ...
            <div class="form-group">
                ...
                <%--回写--%>
                <%--刷新重载界面数据时，回写查询条件数据 value="${condition.email[0]}"--%>
    ...
    <form id="form" action="${pageContext.request.contextPath}/delSelectedServlet" method="post" onsubmit="return check()">
